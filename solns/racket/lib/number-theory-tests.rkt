...
(define number-theory-tests
  (test-suite
    ...
    (check = (count-digits -10) 2 "-10 has 2 digits")
    (check = (count-digits -1) 1 "-1 has 1 digit")
    (check = (count-digits 0) 1 "0 has 1 digit")
    (check = (count-digits 1) 1 "1 has 1 digit")
    (check = (count-digits 72) 2 "72 has 2 digits")
    (check = (count-digits 234) 3 "234 has 3 digits")
    (check = (count-digits 0321) 3 "0321 has 3 digits")
